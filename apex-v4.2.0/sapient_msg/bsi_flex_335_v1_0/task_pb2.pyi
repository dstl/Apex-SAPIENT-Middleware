...
class Task(_message.Message):
    ...
    class Operator(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        OPERATOR_UNSPECIFIED: _ClassVar[Task.Operator]
        OPERATOR_ALL: _ClassVar[Task.Operator]
        OPERATOR_GREATER_THAN: _ClassVar[Task.Operator]
        OPERATOR_LESS_THAN: _ClassVar[Task.Operator]
        OPERATOR_EQUALS: _ClassVar[Task.Operator]
    OPERATOR_UNSPECIFIED: Task.Operator
    OPERATOR_ALL: Task.Operator
    OPERATOR_GREATER_THAN: Task.Operator
    OPERATOR_LESS_THAN: Task.Operator
    OPERATOR_EQUALS: Task.Operator
    class Command(_message.Message):
        __slots__ = ("request", "detection_threshold", "detection_report_rate", "classification_threshold", "mode_change", "look_at", "command_parameter")
        ...
        mode_change: str
        look_at: Task.LocationOrRangeBearing
        command_parameter: str
        def __init__(self, request: _Optional[str] = ..., detection_threshold: _Optional[_Union[Task.DiscreteThreshold, str]] = ..., detection_report_rate: _Optional[_Union[Task.DiscreteThreshold, str]] = ..., classification_threshold: _Optional[_Union[Task.DiscreteThreshold, str]] = ..., mode_change: _Optional[str] = ..., look_at: _Optional[_Union[Task.LocationOrRangeBearing, _Mapping]] = ..., command_parameter: _Optional[str] = ...) -> None: ...
    class Region(_message.Message):
        ...
        region_id: str
        region_name: str
        region_area: Task.LocationOrRangeBearing
        ...
        def __init__(self, type: _Optional[_Union[Task.RegionType, str]] = ..., region_id: _Optional[str] = ..., region_name: _Optional[str] = ..., region_area: _Optional[_Union[Task.LocationOrRangeBearing, _Mapping]] = ..., class_filter: _Optional[_Iterable[_Union[Task.ClassFilter, _Mapping]]] = ..., behaviour_filter: _Optional[_Iterable[_Union[Task.BehaviourFilter, _Mapping]]] = ...) -> None: ...
    ...
    class Parameter(_message.Message):
        ...
        value: float
        def __init__(self, name: _Optional[str] = ..., operator: _Optional[_Union[Task.Operator, str]] = ..., value: _Optional[float] = ...) -> None: ...
